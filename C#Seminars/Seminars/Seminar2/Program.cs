...
// Task 4
Console.Clear();
void ifDividedWithZero (int num, int num2)
{
    if (num % num2 == 0)
    {
        Console.WriteLine($"{num} divided by {num2} without any rest");
    }
    else
    {
        int TheRest = num % num2;
        Console.WriteLine($" The rest of divide {num} by {num2} is {TheRest}");   
    }
};
